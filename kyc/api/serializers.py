...
class Kyc_Serializer(serializers.ModelSerializer):
    user_detail = serializers.PrimaryKeyRelatedField( queryset=User.objects.all(), required=False )
   
    class Meta:
        model = Kyc
        fields = [ 'user_detail', 'legal_first_name', 'legal_last_name', 'address_line_1', 'address_line_2',
